...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:5173",
        "http://localhost:5174",
        "https://project-tipak.vercel.app"
    ],
        ...
        return [
            {
                ...
                "materials": r.get("material_findings"),
                "details": f"Rust: {r.get('rust_count', 0)}, Cracks: {r.get('cracks_count', 0)}, Old Wood: {r.get('old_wood_count', 0)}",
